...
def index():
    ...
    img = static_file('33.jpg', root='./', mimetype='image/jpeg')
    return template('index.html', username=username, nav_list=nav_list, blog=blog, blogtag=btag, img='/33.jpg')


@app.route('/<filename>')
def access_static_file(filename):
